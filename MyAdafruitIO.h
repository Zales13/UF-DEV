...
#define IO_USERNAME       "TheTom09"
#define IO_KEY            "4a1f9d55a4184cdba8d7db81b2895196"
// Feeds
...
Adafruit_MQTT_Publish SoilFeed = Adafruit_MQTT_Publish(&MyAdafruitMqtt, IO_USERNAME FEED_SOIL);
/*************************** Sketch Code ************************************/
...
void getAndSendDataToAdafruit(){
  ...
  temperatureFeed.publish(TempVar);
  humidityFeed.publish(HumidityVar);
  SoilFeed.publish(SoilVar);
}
